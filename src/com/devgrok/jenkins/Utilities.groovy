...
class Utilities {
    static def lastStableBuild(jobName, branchName) {
    ...
    static def resolveS3Artifact(parentName, branchName) {
    ...
    static def allBranches(parentName) {
